...
N = params.l2^2 + (s+params.l5)^2 - params.l2*(s+params.l5) * cos(phi-theta);
...
dlr1d2dtheta = ((-2*(s+params.l5) * sd^2 * params.l2 * sin(phi-theta) + 2*(s+params.l5)^2 * ...
    sd * thetad * params.l2 * cos(phi-theta) + params.l2^2 * sd^2 * cos(phi-theta) * sin(phi-theta) ...
...
c_theta = ((-4*(s+params.l5)*sd^2*params.l2 * sin(phi-theta) ...
    ...
    cos(phi-theta) * sin(phi-theta) + 2*l_2^2*(s+params.l5)^2 * thetad * sin(phi-theta)^2) * ...

...
% calculated using help2()
l2 = params.l2; l5 = params.l5;
Der_dlr1d2dthetad = (l2*sin(theta - phi)*(l5 + s)*(2*sd^2 + 2*sdd*(l5 + s) - 2*l2*cos(theta - phi)*sdd + 4*l2*sin(theta - phi)*sd*thetad + 2*l2*cos(theta - phi)*thetad^2*(l5 + s) + 2*l2*sin(theta - phi)*thetadd*(l5 + s)))/((l5 + s)^2 + l2^2 - 2*l2*cos(theta - phi)*(l5 + s)) + (l2*sin(theta - phi)*sd*(2*sd*(l5 + s) - 2*l2*cos(theta - phi)*sd + 2*l2*sin(theta - phi)*thetad*(l5 + s)))/((l5 + s)^2 + l2^2 - 2*l2*cos(theta - phi)*(l5 + s)) - (l2*sin(theta - phi)*(l5 + s)*(2*sd*(l5 + s) - 2*l2*cos(theta - phi)*sd + 2*l2*sin(theta - phi)*thetad*(l5 + s))^2)/((l5 + s)^2 + l2^2 - 2*l2*cos(theta - phi)*(l5 + s))^2 + (l2*cos(theta - phi)*thetad*(l5 + s)*(2*sd*(l5 + s) - 2*l2*cos(theta - phi)*sd + 2*l2*sin(theta - phi)*thetad*(l5 + s)))/((l5 + s)^2 + l2^2 - 2*l2*cos(theta - phi)*(l5 + s));
